...
1. Accesati situl <a href="https://admin.jurnalgold.ro" target="child" rel="">admin.jurnalgold.ro</a> si creati un cont de utilizator (daca nu aveti deja unul).
...
2. Accesati <a href="https://admin.jurnalgold.ro" target="child" rel="">admin.jurnalgold.ro</a>, folosind username si parola setata anterior si veti putea descarca versiunea demo a programului Jurnal Gold de la sectiunea "Demo Jurnal Gold".
